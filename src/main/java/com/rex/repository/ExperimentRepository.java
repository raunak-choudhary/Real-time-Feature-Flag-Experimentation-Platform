...
/**
 * Repository interface for Experiment entity operations. Provides CRUD operations and custom
 * queries for A/B testing experiment management. FIXED: Verified all enum references and query
 * syntax for proper compilation.
 */
@Repository
public interface ExperimentRepository extends JpaRepository<Experiment, Long> {
  ...
  List<Experiment> findByStatusAndEnvironment(
      Experiment.ExperimentStatus status, String environment);
  ...
  List<Experiment> findByStartDateBetween(
  ...
  @Query(
      """
        ...
        """)
  List<Experiment> findByTrafficPercentageRange(
      @Param("minPercentage") Integer minPercentage, @Param("maxPercentage") Integer maxPercentage);
