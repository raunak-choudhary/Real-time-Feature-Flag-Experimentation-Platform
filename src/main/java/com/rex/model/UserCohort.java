...
public class UserCohort {
  ...
  public UserCohort(
      String userId, Experiment experiment, CohortType cohortType, String variantName) {
    this.userId = userId;
  ...
  public long getDaysSinceAssignment() {
    ...
    return java.time.temporal.ChronoUnit.DAYS.between(
        assignedAt.toLocalDate(), LocalDateTime.now().toLocalDate());
  }
  ...
  public long getDaysSinceFirstExposure() {
    ...
    return java.time.temporal.ChronoUnit.DAYS.between(
        firstExposureAt.toLocalDate(), LocalDateTime.now().toLocalDate());
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(userId, that.userId) && Objects.equals(experiment, that.experiment);
  }
