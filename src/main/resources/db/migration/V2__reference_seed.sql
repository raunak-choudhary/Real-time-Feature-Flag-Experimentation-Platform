...
'marketing@rex.com', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP - interval '7 day');
...
('user_006', 4, 'generic_subject', 'CONTROL', 'PERCENTAGE_BASED', CURRENT_TIMESTAMP - interval '10 day', false, 44444, 'production', 'session_006'),
('user_007', 4, 'personalized_subject', 'TREATMENT', 'PERCENTAGE_BASED', CURRENT_TIMESTAMP - interval '10 day', false, 55555, 'production', 'session_007'),
('user_008', 4, 'generic_subject', 'CONTROL', 'PERCENTAGE_BASED', CURRENT_TIMESTAMP - interval '8 day', false, 66666, 'production', 'session_008'),
...
('user_001', 'CLICK', 'cta_button_clicked', NULL, 1, 'blue_button', CURRENT_TIMESTAMP + interval '5 second', 1, 1.0, 'production', 'session_001', '/home', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)', 'desktop', 'web'),
('user_002', 'CLICK', 'cta_button_clicked', NULL, 1, 'red_button', CURRENT_TIMESTAMP + interval '3 second', 1, 1.0, 'production', 'session_002', '/home', 'Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X)', 'mobile', 'ios'),
-- Conversion Events
('user_001', 'CONVERSION', 'signup_completed', NULL, 1, 'blue_button', CURRENT_TIMESTAMP + interval '2 minute', 1, 29.99, 'production', 'session_001', '/signup/complete', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)', 'desktop', 'web'),
('user_004', 'CONVERSION', 'purchase_completed', NULL, 1, 'red_button', CURRENT_TIMESTAMP + interval '5 minute', 1, 99.99, 'production', 'session_004', '/checkout/success', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)', 'desktop', 'web'),
-- Email Campaign Events (Completed Experiment)
('user_006', 'EXPERIMENT_EXPOSURE', 'email_opened', NULL, 4, 'generic_subject', CURRENT_TIMESTAMP - interval '10 day', 1, NULL, 'production', 'session_006', '/email/campaign', 'Email Client', 'mobile', 'email'),
('user_007', 'EXPERIMENT_EXPOSURE', 'email_opened', NULL, 4, 'personalized_subject', CURRENT_TIMESTAMP - interval '10 day', 1, NULL, 'production', 'session_007', '/email/campaign', 'Email Client', 'desktop', 'email'),
('user_007', 'CLICK', 'email_link_clicked', NULL, 4, 'personalized_subject', CURRENT_TIMESTAMP - interval '10 day', 1, 1.0, 'production', 'session_007', '/landing/email', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)', 'desktop', 'web'),
-- Page View Events
...
first_exposure_at = CURRENT_TIMESTAMP - (floor(random() * 60) || ' minutes')::interval,
last_exposure_at = CURRENT_TIMESTAMP,
exposure_count = (1 + floor(random() * 5))::integer
